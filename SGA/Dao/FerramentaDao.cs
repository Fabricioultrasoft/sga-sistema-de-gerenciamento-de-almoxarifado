    ...
    public class FerramentaDao
    {
        ...
        public Queue pesquisaFerramenta(Ferramenta objFerramenta)
        {
            ...
            if (objFerramenta.periodo[0] + "" != "")
            {
                ...
                {
                    comando = comando + " AND dt_aquisicao between '" + Convert.ToDateTime(objFerramenta.periodo[1]).ToString("yyyy-MM-dd HH:mm:ss") + "' AND '" + Convert.ToDateTime(objFerramenta.periodo[2]).ToString("yyyy-MM-dd HH:mm:ss") + "'";
                }
            }
